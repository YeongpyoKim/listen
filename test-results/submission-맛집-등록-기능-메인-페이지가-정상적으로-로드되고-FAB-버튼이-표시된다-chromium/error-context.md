...
- Name: submission.spec.js >> 맛집 등록 기능 >> 메인 페이지가 정상적으로 로드되고 FAB 버튼이 표시된다
- Location: tests/e2e/submission.spec.js:22:3
...
Locator:  locator('#submitFab')
Expected: "내가 아는 교회 동네 맛집 추가하기"
Received: "내가 아는 맛집 추가하기"
Timeout:  5000ms

Call log:
  - Expect "toHaveAttribute" with timeout 5000ms
  - waiting for locator('#submitFab')
    14 × locator resolved to <button id="submitFab" class="submit-fab" title="내가 아는 맛집 추가하기">…</button>
